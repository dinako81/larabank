                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <a href="{{route('clients-addfunds', $client)}}" class="btn btn-success">Add Funds</a>
                                    <a href="{{route('clients-withdrawfunds', $client)}}" class="btn btn-success">Withdraw Funds</a> --}}
                                    <td>
